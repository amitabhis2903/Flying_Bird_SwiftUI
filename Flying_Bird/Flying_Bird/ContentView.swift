...
//  Flying_Bird
//
//  Created by MacBook05 on 04/04/21.
//
    ...
    var body: some View {
        ZStack {
            ...
            ZStack {
                ...
                //MARK:- BODY
                Image("body").resizable().frame(width: 125, height: 150, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
                    .offset(y: -30)
                    .shadow(color: .white, radius: 1.0, x: 0, y: 0)
